...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    <title>ГеймсМаркет - Регистрация</title>
    <meta charset="utf-8">
        ...
        <div class="main-content">
			<form method="POST" action="{{ route('register') }}">
				...
				<div style="margin-bottom: 5px;">
					Введите имя для отображения:<br />
				...
				<!-- Confirm Password -->
				<div class="mt-4" style="margin-bottom: 7px;">
					Повторите введённый ранее пароль:<br />
                ...
                <div style="margin-bottom: 5px;">
                    <x-text-input id="isadmin" class="block mt-1 w-full" type="checkbox" name="isadmin" :value="1" />
